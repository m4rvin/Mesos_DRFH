...
./test-framework-drfh --master=127.0.0.1:5050 --task_cpus_demand=1.1 --task_memory_demand=64MB --offers_limit=200 --offers_stats_file="$FRAMEWORK_STATS_FOLDER/framework-1.txt" &
pid=$!
echo $pid
